...
const handleSubmit = async () => {
  try {
    ...
    const verificationResponse = await StudentService.resetPasswordVerification(formData.email, parseInt(formData.verificationCode))
    ...
    const response = await StudentService.resetPassword(formData) // Llamar al método de restablecimiento
