...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241209142107_UpdateAssignmentTitleConstraint') THEN
    DROP INDEX "IX_Assignments_CourseId";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241209142107_UpdateAssignmentTitleConstraint') THEN
    DROP INDEX "IX_Assignments_Title";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241209142107_UpdateAssignmentTitleConstraint') THEN
    CREATE UNIQUE INDEX "IX_Assignments_CourseId_Title" ON "Assignments" ("CourseId", "Title");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241209142107_UpdateAssignmentTitleConstraint') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20241209142107_UpdateAssignmentTitleConstraint', '8.0.8');
    END IF;
END $EF$;
COMMIT;
